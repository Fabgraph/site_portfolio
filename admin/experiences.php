        ...
        <caption>La liste des expériences : <?php echo $nbr_experiences; ?></caption>
            <thead>
                <tr> 
                    ...
                    <a href="experiences.php?column=titre&order=asc">1</a> |
                    <a href="experiences.php?column=titre&order=desc">10</a>
                    </th>
                    <th class="table-dark">Sous-titre
                    <a href="experiences.php?column=stitre&order=desc">A</a> |
                    <a href="experiences.php?column=stitre&order=asc">Z  </a>
                    </th>
                    <th class="table-dark">Dates
                    <a href="experiences.php?column=dates&order=desc">A</a> |
                    <a href="experiences.php?column=dates&order=asc">Z  </a>
                    </th>
                    <th class="table-dark">Description
                    <a href="experiences.php?column=description&order=desc">A</a> |
                    <a href="experiences.php?column=description&order=asc">Z  </a>
                    </th>
